...
class SiswaKelasTahunAjaranSearch extends SiswaKelasTahunAjaran
{
    ...
    public function search($params)
    {
        ...
        $query->joinWith('idKelasTahunAjaran');
        ...
        $query->andFilterWhere(['like','tbl_kelas_tahun_ajaran.id_tahun_ajaran',(isset($params['TahunAjaran']))?$params['TahunAjaran']['id']:""]);

        $query->andFilterWhere(['like','tbl_kelas_tahun_ajaran.id_kelas',(isset($params['Kelas']))?$params['Kelas']['id']:""]);
